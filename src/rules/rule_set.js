...
var RuleSet = (function () {
    ...
    RuleSet.prototype.config = function (config) {
        ...
        if (config instanceof route_config_impl_1.AuxRoute) {
            ...
            var auxRule = new rules_1.RouteRule(routePath_1, handler, config.name, config.defer);
        ...
        var newRule = new rules_1.RouteRule(routePath, handler, config.name, config.defer);

...
var RouteRule = (function () {
    ...
    function RouteRule(_routePath, handler, _routeName, _defer) {
    ...
    RouteRule.prototype._getInstruction = function (urlPath, urlParams, params) {
        ...
        var instruction = new instruction_1.ComponentInstruction(urlPath, urlParams, this.handler.data, this.handler.componentType, this.terminal, this.specificity, params, this._routeName, this._defer);

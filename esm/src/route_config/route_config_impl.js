...
export class AbstractRoute {
    constructor({ name, useAsDefault, path, regex, serializer, data, defer }) {
        this.name = name;
...
export class Route extends AbstractRoute {
    constructor({ name, useAsDefault, path, regex, serializer, data, component, defer }) {
        super({
            name: name,
...
export class AsyncRoute extends AbstractRoute {
    constructor({ name, useAsDefault, path, regex, serializer, data, loader, defer }) {
        super({
            name: name,
            useAsDefault: useAsDefault,
            path: path,
...
export class Redirect extends AbstractRoute {
    constructor({ name, useAsDefault, path, regex, serializer, data, redirectTo, defer }) {
        super({
            name: name,
            useAsDefault: useAsDefault,
            path: path,
